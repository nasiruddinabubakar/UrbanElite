      ...
      <div style={starContainerStyle}>
        {Array.from({ length: maxRating }, (_, i) => (
          <Star
            ...
            onRating={() => setRating(tempRating)}
            onLeaveTempRating={() => setTempRating(0)}
          />
        ))}
      </div>
...
interface StarProps{
  onTempRating:()=>void,
  onLeaveTempRating:()=>void,
  onRating:()=>void,
  isFull:boolean
};
function Star({ onTempRating, onLeaveTempRating, onRating, isFull }:StarProps) {
  return (
    <span
      style={starStyle}
